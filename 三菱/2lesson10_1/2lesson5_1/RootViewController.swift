    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItems = [
            UIBarButtonItem.init(title: "picker", primaryAction: UIAction(handler: { _ in
                ...
                let pickerNavi = storyboard.instantiateViewController(withIdentifier: "picker_navi") as! UINavigationController
            ...
            UIBarButtonItem.init(title:"thermometer", primaryAction: UIAction(handler: { _ in
                let storyboard = UIStoryboard(name: "Main", bundle: nil)
                let thermometer_navi = storyboard.instantiateViewController(withIdentifier: "thermometer_navi") as! UINavigationController
                self.present(thermometer_navi, animated: true)
            }))
        ]
